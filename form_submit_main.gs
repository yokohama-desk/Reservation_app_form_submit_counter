...
* Formが送信されたら回答されたリストアイテムは内容を「満席」などに書き換える
        ...
        for(var k =0;k<choices.length;k++){//for3
          ...
          if(choice === userres){//if2
            ...
            if(0<restnum){//if3
              ...
              var fullchoice = choice.substr(0,inumstart) + fullstr
              rests.push(fullchoice);
            }//if3
          }else{
              rests.push(choice);
           }//if2
